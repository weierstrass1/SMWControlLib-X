...
namespace SMWControlLibSNES.Factory.Graphics
{
    ...
    /// </summary>
    public class DirtySNESSpriteTileFactory : DirtyTileFactory<byte, ColorA1R5G5B5>
    {
        /// <summary>
        ...
        public override DirtyTile<byte, ColorA1R5G5B5> GenerateObject(params object[] args)
        {
